 ...
 */
class MemberTeam extends \Meritocracy\Entity\MemberTeam implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'role', 'photo', 'facebookUrl', 'twitterUrl', 'linkedinUrl', 'company', 'createdAt', 'updatedAt', 'rules', 'importId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MemberTeam $proxy) {
    ...
    public function setLinkedinUrl($linkedinUrl)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLinkedinUrl', [$linkedinUrl]);
