 ...
 */
class CompanyHasTag extends \Meritocracy\Entity\CompanyHasTag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'company', 'tag', 'createdAt', 'updatedAt', 'rules', 'importId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompanyHasTag $proxy) {
