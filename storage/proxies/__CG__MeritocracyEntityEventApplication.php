 ...
 */
class EventApplication extends \Meritocracy\Entity\EventApplication implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'application', 'status', 'comment', 'title', 'author', 'createdAt', 'updatedAt', 'rules', 'importId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventApplication $proxy) {
