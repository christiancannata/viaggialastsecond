 ...
 */
class Qualification extends \Meritocracy\Entity\Qualification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'valutation', 'user', 'date', 'createdAt', 'updatedAt', 'rules', 'importId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Qualification $proxy) {
    ...
    public function getValutation()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getValutation', []);

        return parent::getValutation();
    }
    ...
    public function setValutation($valutation)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setValutation', [$valutation]);

        return parent::setValutation($valutation);
    }
