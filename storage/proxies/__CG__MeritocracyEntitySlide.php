 ...
 */
class Slide extends \Meritocracy\Entity\Slide implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Meritocracy\\Entity\\Slide' . "\0" . 'temp', '' . "\0" . 'Meritocracy\\Entity\\Slide' . "\0" . 'path', 'company', 'name', 'link', 'visible', 'ordering', '' . "\0" . 'Meritocracy\\Entity\\Slide' . "\0" . 'file', 'status', 'createdAt', 'updatedAt', 'rules', 'importId'];
        }
