 ...
 */
class LanguageUser extends \Meritocracy\Entity\LanguageUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'gradeWrite', 'gradeSpeak', 'gradeRead', 'comment', 'languagePlainText', 'systemLanguage', 'createdAt', 'updatedAt', 'rules', 'importId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LanguageUser $proxy) {
