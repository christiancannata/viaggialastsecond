 ...
 */
class JobTitle extends \Meritocracy\Entity\JobTitle implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'category', 'nameIt', 'createdAt', 'updatedAt', 'rules', 'importId'];
        }
