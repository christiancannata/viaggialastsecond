 ...
 */
class Vacancy extends \Meritocracy\Entity\Vacancy implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'rules', 'id', 'name', 'facebookPixel', 'description', 'permalink', 'openDate', 'closedDate', 'status', 'sort', 'mongoidStudyField', '' . "\0" . 'Meritocracy\\Entity\\Vacancy' . "\0" . 'studyField', 'mongoidIndustry', '' . "\0" . 'Meritocracy\\Entity\\Vacancy' . "\0" . 'industry', 'mongoidJobFunction', '' . "\0" . 'Meritocracy\\Entity\\Vacancy' . "\0" . 'jobFunction', 'cityPlainText', 'isActive', 'seniority', 'systemLanguage', 'requestedLanguages', 'user', 'company', 'city', 'scoresCvm', 'applications', 'createdAt', 'updatedAt', 'importId'];
        }
     ...
     * {@inheritDoc}
     */
    public function getScoresCvm()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getScoresCvm', []);

        return parent::getScoresCvm();
    }

    /**
     * {@inheritDoc}
     */
    public function setScoresCvm($scoresCvm)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setScoresCvm', [$scoresCvm]);

        return parent::setScoresCvm($scoresCvm);
    }
    ...
    public function getRequestedLanguages()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRequestedLanguages', []);

        return parent::getRequestedLanguages();
    }
    ...
    public function setRequestedLanguages($requestedLanguages)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRequestedLanguages', [$requestedLanguages]);

        return parent::setRequestedLanguages($requestedLanguages);
    }
