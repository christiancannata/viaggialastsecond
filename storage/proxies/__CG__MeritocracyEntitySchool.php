 ...
 */
class School extends \Meritocracy\Entity\School implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'name', 'city', 'place', 'link', 'type', 'events', 'scores', 'country', 'createdAt', 'updatedAt', 'rules', 'importId'];
        }
