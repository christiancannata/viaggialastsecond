 ...
 */
class Attachment extends \Meritocracy\Entity\Attachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Meritocracy\\Entity\\Attachment' . "\0" . 'temp', 'comment', 'type', 'user', 'name', 'link', '' . "\0" . 'Meritocracy\\Entity\\Attachment' . "\0" . 'file', 'createdAt', 'updatedAt', 'rules', 'importId'];
        }
