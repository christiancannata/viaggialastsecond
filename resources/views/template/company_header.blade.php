            ...
            <div class="nav-wrapper">
                <ul class="left">
                    ...
                    <li><h1 class="logo-wrapper"><a href="/hr"
                                        ...
                                        src="https://meritocracy.is/img/logos/white-full-logo.png"
                                        alt="Meritocracy logo"></a> <span
                ...
                <div class="header-search-wrapper">
                    ...
                    "Search" id="search" data-filter="company" data-id="{{\Illuminate\Support\Facades\Auth::user()->company['id']}}" class="header-search-input z-depth-2 search-hr"
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="/{{Auth::user()->company['permalink']}}" target="_blank" data-activates="chat-out"
                           class="waves-effect waves-block waves-light preview-company-page"><i
                                    class="mdi-action-home" style="display: inline;"></i><span>Branding page</span></a>
                    </li>
