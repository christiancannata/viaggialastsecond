                    ...
                    <form id="wizard" action="#">
                                ...
                                <div class="nano-content">
                                    ...
                                    <div class="row">
                                        <div class="input-field col col-md-15 col-xs-16">
                                            ...
                                            <input onkeydown="return false" type="text" name="data_inizio" id="data_inizio"
                                    ...
                                    <div class="row">
                                        <div class="input-field col col-md-10 col-xs-16">
                                            ...
                                            <input onkeydown="return false" type="text" name="data_fine" id="data_fine"
                                                   class="datepicker required" required>
                                ...
                                <div class="nano-content">
                                    ...
                                    <div class="row">
                                        <div class="input-field col col-md-15 col-xs-16">
                                            ...
                                            <input onkeydown="return false" type="text" name="data_inizio_education" id="data_inizio_education"
                                                   class="datepicker required" required>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="input-field col col-md-10 col-xs-16">
                                            ...
                                            <input onkeydown="return false" type="text" name="data_fine_education" id="data_fine_education"
                                                   class="datepicker required" required>
                        ...
                        <fieldset>
                            <legend id="summary-legend">
                                {{ trans($route.'.candidatura_completata_subtitle') }}
                            </legend>
                            ...
                            <div class="row">
                                ...
                                <div class="col col-md-16 hide" id="thank-you-box">
                                    <h4>Complimenti, la tua candidatura è andata a buon fine! </h4>
...
@section('page-scripts')
    ...
    <script type="text/javascript" src="/js/pages/wizard-application.js"></script>
