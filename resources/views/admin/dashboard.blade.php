        ...
        <div class="col s12 m12 l4">
            <ul id="task-card" class="collection with-header">
                ...
                <li class="collection-item dismissable">
                    ...
                    <label for="task1">Create Mobile App UI. <a href="#" class="secondary-content"><span
                ...
                <li class="collection-item dismissable">
                    ...
                    <label for="task2">Check the new API standerds. <a href="#" class="secondary-content"><span
                ...
                <li class="collection-item dismissable">
                    ...
                    <label for="task3">Check the new Mockup of ABC. <a href="#" class="secondary-content"><span
        ...
        <div class="col s12 m6 l4">
            <div id="profile-card" class="card">
                <div class="card-image waves-effect waves-block waves-light">
                    <img class="activator" src="/admin/images/user-bg.jpg" alt="user background">
                </div>
                <div class="card-content">
    ...
    <div class="row">
        ...
        <div class="col s12 m12 l4">
            <div class="blog-card">
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                        <img src="/admin/images/gallary/30.jpg" alt="blog-img">
                    </div>
                    ...
                    <div class="card-content">
                        ...
                        <h4 class="card-title grey-text text-darken-4"><a href="#" class="grey-text text-darken-4">Materialize
            ...
            <div class="product-card">
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                        ...
                        <img src="/admin/images/gallary/33.jpg" alt="product-img">
                    </div>
                    <ul class="card-action-buttons">
                        <li><a class="btn-floating waves-effect waves-light green accent-4"><i
                    ...
                    <div class="card-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col s4 no-padding">
                                <a href="#"></a><img src="/admin/images/amazon.jpg" alt="amazon" class="responsive-img">
