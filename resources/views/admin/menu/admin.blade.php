<li class="bold"><a href="/user/dashboard" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> Dashboard</a>
</li>

<li class="bold"><a href="/user/profile" class="waves-effect waves-cyan"><i class="mdi-action-account-circle"></i> Il tuo profilo</a>
</li>

<li class="bold"><a href="/user/attachments" class="waves-effect waves-cyan"><i class="mdi-file-cloud-circle"></i> Allegati</a>
</li>

<li class="bold"><a href="/user/activities" class="waves-effect waves-cyan"><i class="mdi-image-timer"></i> Registro attività</a>
</li>

<li class="bold"><a href="/user/settings" class="waves-effect waves-cyan"><i class="mdi-action-settings"></i> Impostazioni</a>
</li>

<li  class="bold"><a href="/user/logout"><i class="mdi-hardware-keyboard-tab"></i> Logout</a>
