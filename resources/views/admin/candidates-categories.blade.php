        ...
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumbs">
                    ...
                    <li><a href="/hr/db/categories">Saved candidates</a></li>
                    <li>{{$title }}</li>
                </ol>
            </div>
        </div>
...
@section('content')
    <input type="hidden" id="id_category" value="{{$category['id']}}">
...
@section('page-scripts')
    ...
    <script type="text/javascript"
            src="{{auto_version("/admin/js/vacancy-db-candidates.js")}}"></script>
