                    ...
                    <div class="content">
                        <div class="row">
                            <div id="site-layout-example-top" class="col s12">
                                <p class="flat-text-logo center white-text caption-uppercase">{{trans('common.error_header_404')}}</p>
                            </div>
                            <div id="site-layout-example-right" class="col s12 m12 l12">
                                <div class="row center">
                                    <h2 style="font-size: 50px;" class="white-text text-long-shadow col s12">{{trans('common.error_title_404')}}</h2>
                                </div>
                                <div class="row center">
                                    <p style="font-size: 20px;" class="center white-text col s12 ">{!! trans('common.error_desc_404') !!}</p>
                                    <p class="center s12">
