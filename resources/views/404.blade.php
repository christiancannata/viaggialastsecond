            ...
            <div class="row">
                <div class="col col-md-16 col-xs-16">
                    ...
                    <h2 style="font-size: 80px;"
                        class="white-text center col s12 fadeInDown animated">{{trans('common.error_title_404')}}</h2>

                    <h3
                       class="center white-text col-md-12 col-md-offset-2 col-xs-12 col-xs-offset-2 fadeInDown animated">{!! trans('common.error_desc_404') !!}</h3>
                    </h3>
