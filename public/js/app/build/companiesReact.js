...
ReactDOM.render(
    React.createElement(JobsApp, {url: url, limit: limit, pollInterval: 6000000}),
    document.getElementById('companies')
);

},{"./components/JobsApp.react":161,"react":158,"react-dom":2}],160:[function(require,module,exports){
/**
    ...
    render: function () {
        ...
        return (
            React.createElement("div", {className: "col col-md-8"}, 
                React.createElement("div", {style: divStyle, className: "box animated fadeIn"}, 
                        React.createElement("div", {className: "float-left", dangerouslySetInnerHTML: isNew()}), 
                                ...
                                React.createElement("div", {className: "row hidden-sm hidden-xs"}, 
                                    React.createElement("div", {className: "col col-md-8 col-sm-6"}, 
                                        React.createElement("div", {className: "job-description"}, 
                                            ...
                                            React.createElement("div", {className: "col col-md-13"}, 
                                                React.createElement("a", {href: permalink, className: "btn btn-red"
                                                   }, trans('company_page_button'))
                                            )
                                        )
                                    ), 
                                    ...
                                    React.createElement("img", {src: "/img/premium.png", className: premiumClass})
                                ), 
                                ...
                                React.createElement("div", {className: "row hidden-lg hidden-md"}, 
                                    React.createElement("div", {className: "col col-md-16"}, 
                                        React.createElement("div", {className: "job-description"}, 
                                            ...
                                            React.createElement("div", {className: "col col-md-13"}, 
                                                React.createElement("a", {href: permalink, className: "btn btn-red"}, trans('company_page_button'))
                                            )
                                        )
                                    )
                                )
...
},{"./JobsGrid.react":162,"react":158}],162:[function(require,module,exports){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
    ...
    render: function () {
        ...
        var jobsNodes = this.props.data.map(function (job) {
            if (job.sliders[0] != null && job.sliders[0].link != null) {
                ...
                return (
                    React.createElement(Job, {isNew: job.is_new, key: job.id, company: job.name, city: job.city_plain_text, link: job.permalink, 
