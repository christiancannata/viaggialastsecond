...
var Vacancies = React.createClass({displayName: "Vacancies",
    ...
    render: function () {
        ...
        if(this.props.company_page!="meritocracy-test"){
            return (
                React.createElement("div", {className: "col-md-16 jobs-stat animated fadeIn"}, 
                    React.createElement("div", {className: "row"}, 
                        React.createElement("div", {className: "col-md-4 col-xs-7 col-sm-4"}, 
                            React.createElement("div", {className: ""}, 
                                React.createElement("p", {className: "vacancy-location-value company-name"}, this.props.company), 

                                React.createElement("img", {className: "portfolio-image img-responsive", 
                                     src: this.props.img, 
                                     alt: ""}), 

                                React.createElement("div", {className: "vacancy-info hidden-xs"}, 
                                    React.createElement("span", {className: "vacancy-location text-uppercase"}, "Location"), 

                                    React.createElement("p", {className: "vacancy-location-value"}, this.props.city)
                                )
                            )
                        ), 
                        React.createElement("div", {className: "col-md-8 col-xs-9 col-sm-12"}, 
                            React.createElement("h4", {className: "vacancy-name", dangerouslySetInnerHTML: vacancyName()}), 

                            React.createElement("span", {className: "vacancy-purpose hidden-xs"}, trans('job_purpose')), 

                            React.createElement("p", {className: "vacancy-description hidden-xs"}, description.substring(0, 300), "..."), 

                            React.createElement("div", {className: "vacancy-info hidden-md hidden-lg"}, 
                                React.createElement("p", {className: "vacancy-location-value"}, this.props.city)
                            )
                        ), 
                        React.createElement("div", {className: "col col-xs-16 hidden-md hidden-lg"}, 
                            React.createElement("p", {className: "vacancy-description"}, this.props.description)
                        ), 
                        React.createElement("div", {className: "col-md-4 col-xs-16"}, 
                            React.createElement("a", {href: permalink}, 
                                React.createElement("button", {className: "btn btn-red btn-block"}, trans('apply_now_button'))
                            ), 

                            React.createElement("a", {href: permalink_azienda}, 
                                React.createElement("button", {className: "btn dark-button btn-block"}, trans('esplora_azienda'))
                            ), 


                            React.createElement("p", {className: "vacancy-share-job text-center text-uppercase red "}, 
                                trans('share_job')), 

                            React.createElement("ul", {className: "soc text-center soc-violet", 
                                "data-share-title": this.props.name, 
                                "data-share-link": permalink
                            }, 
                                React.createElement("li", null, React.createElement("a", {className: "soc-linkedin", href: "#"})), 
                                React.createElement("li", null, React.createElement("a", {className: "soc-facebook", href: "#"})), 
                                React.createElement("li", null, React.createElement("a", {className: "soc-twitter", href: "#"}))
                            )
                        )
                    )
                )
    ...
    render: function () {
        return (
            React.createElement("div", {className: "vacanciesBox"}, 
                this.state.loading
                    ? React.createElement("div", {className: "job-loading"}, React.createElement("i", {className: "fa fa-circle-o-notch fa-spin fa-4x fa-fw margin-bottom"}))
                    : React.createElement(VacanciesGrid, {data: this.state.data}), 
                
                React.createElement(Paginator, {max: this.state.pages, maxVisible: this.state.pages, onChange: this.onChangePage})
...
},{"../utils/paginator":162,"./VacanciesGrid.react":161,"react":158}],161:[function(require,module,exports){
/**
 * Copyright (c) 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
  ...
  render: function () {
    var vacanciesNodes = this.props.data.map(function (obj) {
        ...
        if(obj.is_visible == true){
            return (
                React.createElement(Vacancies, {isNew: obj.is_new, permalink: obj.permalink, company: obj.company.name, company_page: obj.company.permalink, key: obj.id, img: obj.company.logo_small, city: obj.city_plain_text, 
    ...
    return (
          React.createElement("div", {className: "row vacancy-block vacancy-hold"}, 
            vacanciesNodes
          )
    );
  }
...
},{"./Vacancies.react":159,"react":158}],162:[function(require,module,exports){
/**
...
ReactDOM.render(
    ...
    React.createElement(VacanciesApp, {limit: 15, url: url, pollInterval: 6000000}),
...
},{"./components/VacanciesApp.react":160,"react":158,"react-dom":2}]},{},[163]);
